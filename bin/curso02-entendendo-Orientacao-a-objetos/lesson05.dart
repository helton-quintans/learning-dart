...
Legume mandioca = Legume('macaxeira', 75, 'marron', true);
Fruta banana = Fruta('Banana', 32, 'amarela', 5);
Nozes castanha = Nozes('Castanha', .89, 'castanho claro', 30, 95);
Citricas limao = Citricas('Limão', 22.2, 'verde', 7, 89.9);
